...
boxplot(cbMenSub$age ~ cbMenSub$year, ylab = "Age", xlab = "Year", col = c
...
boxplots shows the median age value gradually decreasing over time, with 2011 as the only exception. The 
data, as shown in the boxplot, does not have any significant outliers which leads to the conclusion the data 
