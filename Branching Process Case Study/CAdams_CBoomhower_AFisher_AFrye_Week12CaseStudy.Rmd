...
* **Analysis of Results (barplots) - Cory**
...
config.delta <- (mcGridAlive-mcGridProp20kids)
formattable(as.data.frame(cbind(test.names, mcGridAlive, mcGridProp20kids, config.delta)))
```
