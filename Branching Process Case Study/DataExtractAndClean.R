#######################################################################
### This file is a duplicate copy from our previous Spam Case Study.
### New R code provided for the Branching Process Case Study can 
### be found at: http://www.rdatasciencecases.org/BirthDeathProcess/code.R
#######################################################################
