...
##Methods
The steps used for this analysis were: 1) data acquistion via scraping the Web; 2) reading data into R and data clean up to correctly format race results tables; 3) quantile-quantile plots analysis; 4) boxplots analysis; & 5) density curves analysis.
